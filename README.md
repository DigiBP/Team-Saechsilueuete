...
o Modelling artefacts (such as BPMN, DMN, CMMN, etc.) and, if required, other pro-
ject artefacts (such as configuration files, source code, etc.)
o Documentation about project and processes (as GitHub markdown files (e.g., Re-
adme and interlinked .md files)).
