# Installation for external python worker for Team Saechsiluute
...
5. Use for the doc_url a working link (must be accessible as with "anyone with the link") from google docs or use the following example link:
