...
class GetScoreClient:
    def __init__(self):
        self.worker = cam.Client("https://digibp.herokuapp.com/engine-rest")
        self.worker.subscribe("GetScore2", self.get_score_callback, "saechsiluute")
        self.worker.polling()

    def get_score_callback(self, taskid, response):
        ...
        output = "CaseID_{0}_SwissMedicID_{1}.docx".format(case_id, swissmedic_id)
        ...
        variables = {"comp_score": comp_score, "doc_check_message": doc_check_message}
